...
export default function LibrarianLayout({
  ...
  useEffect(() => {
    if (
      !isLoading &&
      !user &&
      !pathname.includes('/librarian/login') &&
      !pathname.includes('/librarian/register')
    ) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                />
                <span className="text-xl font-bold text-academic-blue">
                  Academic Nexus
                </span>
              </Link>
              {user && (
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        pathname !== '/librarian/register' ? (
          <div className="flex justify-center items-center h-64">
            <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-academic-blue" />
          </div>
        ) : (
          children
        )}
